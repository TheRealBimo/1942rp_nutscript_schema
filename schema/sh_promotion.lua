...
ranks = {
  ...
  nsdap = {
	...
	(name = "Gauleiter", model = "models/kriegsyntax/germans/nsdap/highcommand/reichsleiter/playermodel.mdl"),
  ...
  ss = {
	...
	{name = "SS Brigadeführer", model = "models/kriegsyntax/germans/ss/cos/brigadefuhrer/playermodel.mdl"},
	{name = "SS Gruppenführer", model = "models/kriegsyntax/germans/ss/cos/gruppenfuhrer/playermodel.mdl"},
	{name = "SS Obergruppenführer", model = "models/kriegsyntax/germans/ss/cos/obergruppenfuhrer/playermodel.mdl"},
	{name = "SS Oberstgruppenführer", model = "models/kriegsyntax/germans/ss/cos/oberstgruppenfuhrer/playermodel.mdl"},
  },
  orpo = {
  ...
  waffen = {
    {name = "Waffen SS Schütze", model = "models/kriegsyntax/germans/waffenss/enlisted/schutze/playermodel.mdl"},
    {name = "Waffen SS Oberschütze", model = "models/kriegsyntax/germans/waffenss/enlisted/oberschutze/playermodel.mdl"},
    {name = "Waffen SS Sturmmann", model = "models/kriegsyntax/germans/waffenss/enlisted/sturmmann/playermodel.mdl"},
    {name = "Waffen SS Rottenführer", model = "models/kriegsyntax/germans/waffenss/enlisted/rottenfuhrer/playermodel.mdl"},

    {name = "Waffen SS Unterscharführer", model = "models/kriegsyntax/germans/waffenss/ncos/unterscharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Scharführer", model = "models/kriegsyntax/germans/waffenss/ncos/scharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Oberscharführer", model = "models/kriegsyntax/germans/waffenss/ncos/oberscharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Hauptscharführer", model = "models/kriegsyntax/germans/waffenss/ncos/hauptscharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Sturmscharführer", model = "models/kriegsyntax/germans/waffenss/ncos/stabsscharfuhrer/playermodel_2.mdl"},

    {name = "Waffen SS Untersturmführer", model = "models/kriegsyntax/germans/waffenss/cos/untersturmfuhrer/playermodel.mdl"},
    {name = "Waffen SS Obersturmführer", model = "models/kriegsyntax/germans/waffenss/cos/obersturmfuhrer/playermodel.mdl"},
    {name = "Waffen SS Hauptsturmführer", model = "models/kriegsyntax/germans/waffenss/cos/hauptsturmfuhrer/playermodel.mdl"},
    {name = "Waffen SS Sturmbannführer", model = "models/kriegsyntax/germans/waffenss/cos/sturmbannfuhrer/playermodel.mdl"},
    {name = "Waffen SS Obersturmbannführer", model = "models/kriegsyntax/germans/waffenss/cos/obersturmbannfuhrer/playermodel.mdl"},
    {name = "Waffen SS Standartenführer", model = "models/kriegsyntax/germans/waffenss/cos/standartenfuhrer/playermodel.mdl"},
    {name = "Waffen SS Oberführer", model = "models/kriegsyntax/germans/waffenss/cos/oberfuhrer/playermodel.mdl"},
